    ...
    <section className="default-section">
      <div className="page-container">
        ...
        <div className="pills-group mt-5 flex flex-col gap-3 sm:w-[700px] w-full m-auto">
          <Pills title="What is partner from ESL pro League?">
            <p>
              Currently, 15 teams jointly govern and participate in revenue for ESL Pro League. They also have long-term
          ...
          <Pills title="Can not partner team take part the league?">
            <p>
              Yes, ESL Pro League is open for everyone to play in regardless of partner status. We believe in an open
          ...
          <Pills title="Do partner teams get preferential seeding in the league?">
            <p>
            Seeding for the groups of ESL Pro League is done based on the ESL World Ranking and independent of partner status.
            </p>
          </Pills>
        </div>
      </div>
