  ...
  return (
    <div className='flex flex-col items-center'>
      ...
      <div className='team-name w-full text-center flex items-center pt-4'>
        <p className='uppercase bg-soft-black w-10/12 m-auto py-3 font-bold text-xl text-white font-inter'>{teamName}</p>
      </div>
    </div>
  );
};
    ...
    <section className='default-section'>
      <div className='page-container'>
       ...
       <div className='time-wrapper relative -mt-3'>
         <div className='time m-auto w-[280px] bg-secondary font-plus-jakarta-sans font-bold flex flex-col items-center p-4'>
