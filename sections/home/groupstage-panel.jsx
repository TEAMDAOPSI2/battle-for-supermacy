...
const Team = ({ team }) => {
  return(
    <div className='flex flex-row items-center font-inter gap-6'>
      ...
      <div className='text'>
        <p className='text-white text-lg uppercase font-medium font-inter'>{team?.name}</p>
      </div>
    </div>
  )
};
  ...
  return (
    <div className='py-6'>
      ...
      <div className='watch-btn'>
        <Link href='/'
              className='flex bg-secondary w-1/5 py-3 rounded-md items-center m-auto hover:bg-emerald-50 transition-all duration-75 ease-in-out'>
